...
local function in_mathzone()
	...
	while node do
		...
		if t == "inline_formula" or t == "displayed_equation" or
			t == "math_environment" or t == "equation_environment" or
			t == "align_environment" or t == "gather_environment" or
			t == "multline_environment" then
			return true
		end
		node = node:parent()
	end
...
return {
	s("label", { t("\\label{eq:"), i(1), t("}"), i(0) }),
	s("ref", { t("\\ref{"), i(1), t("}"), i(0) }),
	s("eref", { t("\\eqref{eq:"), i(1), t("}"), i(0) }),
}, {
	-- Latex specific
	s("ee", { t({ "\\e^{" }), i(1), t({ "} " }), i(0) }, { condition = in_mathzone }),
	s("dm", { t({ "\\[", "    " }), i(1), t({ "", "\\]" }), i(0), }),
	s({ trig = "ali", priority = 500 }, { t({"\\begin{align*}", "    " }), i(1), t({ "", "\\end{align*}" }), i(0), }, { condition = conds.line_begin }),
	s({ trig = "eq", priority = 500 }, { t({"\\begin{equation}", "    " }), i(1), t({ "", "\\end{equation}" }), i(0), }, { condition = conds.line_begin }),
	s("mk", { t("\\("), i(1), t("\\)"), i(0), }),
	s("dv", { t({ "\\frac{\\d " }), i(1), t({ "}{\\d " }), i(2), t("} "), i(0) }, { condition = in_mathzone }),
	s("dd", { t("\\d ") }, { condition = in_mathzone }),
	s("slash", { t("\\slashed{"), i(1), t("} "), i(0) }, { condition = in_mathzone }),
	s("OO", { t("\\O") }, { condition = in_mathzone }),
	s("ZZ", { t("\\Z") }, { condition = in_mathzone }),
	s("QQ", { t("\\Q") }, { condition = in_mathzone }),
	s("RR", { t("\\R") }, { condition = in_mathzone }),
	s("Rn", { t("\\R^n") }, { condition = in_mathzone }),
	s("CC", { t("\\C") }, { condition = in_mathzone }),
	s("Cn", { t("\\C^n") }, { condition = in_mathzone }),
	s("HH", { t("\\H") }, { condition = in_mathzone }),
	s("DD", { t("\\D") }, { condition = in_mathzone }),
	s("env", {
		t("\\begin{"), i(1), t({"}",
			"\t"}), i(0),
